...
export default({
  ...
  return createShipmentModel ? (
    <div className="fixed inset-0 z-10 overflow-y-auto">
      <div className="fixed inseet-0 w-full h-full bg-black opacity-40"
            ...
            <div className=":flex justify-end">
              ...
              >
                ...
                >
                  ...
                  414L11.414 1014.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.
            ...
            <div className="max-w-sm mx-auto py-3 space-y-3 text-center">
              ...
              <form onSubmit={(e)=>e.preventDefault()}>
                <div className="relative mt-3">
                  ...
                  outline-none borderfocus:border-indigo-600 shadow-sm
                   rounded-lg"
                   onChange={(e)=>
                    setShipment({
                      ...shipment,
